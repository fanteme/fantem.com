  ...
  <main class="main">
    <section class="products">
      <div class="hero">
        <div
          class="hero-body"
          :style="{backgroundImage: `url(${$store.state.cdn}/2018/11/c95c3bfd1d4d0cc36c4799ce253f1af0.jpg)`}"
        ></div>
      </div>
      <div class="container">
          ...
          <div class="columns is-gapless">
            <div class="column is-8">
              <nuxt-link :to="`/${this.$store.state.locale}/products/touch`">
                <div class="img-wrap">
                  <img
                    :src="`${this.$store.state.cdn}/2018/10/0fc8cb72096f67de319ee559bc53c677.png`"
                    alt
                  >
                </div>
              </nuxt-link>
          ...
          <div class="columns is-multiline">
            <div class="column">
              <nuxt-link :to="`/${this.$store.state.locale}/products/cube`">
                <div class="img-wrap">
                  <img
                    :src="`${this.$store.state.cdn}/2018/10/36f5d4fea4f4f1c26f68c37bfa70a026.png`"
                    alt
                  >
                </div>
                <div class="content-wrap">
            ...
            <div class="column">
              <nuxt-link :to="`/${this.$store.state.locale}/products/hub`">
                <div class="img-wrap">
                  <img
                    :src="`${this.$store.state.cdn}/2018/10/9e1d66d8ffa3fd5772ab668eb99331fc.png`"
                    alt
                  >
                </div>
                <div class="content-wrap">
          ...
          <div class="columns is-multiline">
            <div class="column is-6">
              <nuxt-link :to="`/${this.$store.state.locale}/products/plug`">
                <div class="img-wrap">
                  <img
                    :src="`${this.$store.state.cdn}/2018/10/8c936b8a72123f791a051e1958ef7897.png`"
                    alt
                  >
                </div>
                <div class="content-wrap">
            ...
            <div class="column is-6">
              <nuxt-link :to="`/${this.$store.state.locale}/products/powersocket`">
                <div class="img-wrap">
                  <img
                    :src="`${this.$store.state.cdn}/2018/10/0952af6e1b9c16c925f74052f688714b.png`"
                    alt
                  >
                </div>
                <div class="content-wrap">
            ...
            <div class="column is-6">
              <nuxt-link :to="`/${this.$store.state.locale}/products/mote`">
                <div class="img-wrap">
                  <img
                    :src="`${this.$store.state.cdn}/2018/10/5e5ae9abb6a1b0ce07be45c1b76bea75.png`"
                    alt
                  >
                </div>
                <div class="content-wrap">
            ...
            <div class="column is-6">
              <nuxt-link :to="`/${this.$store.state.locale}/products/smartswitch`">
                <div class="img-wrap">
                  <img
                    :src="`${this.$store.state.cdn}/2018/10/141890ba007ea3450083a6e4adf637a0.png`"
                    alt
                  >
                </div>
                <div class="content-wrap">
            ...
            <div class="column is-6">
              <nuxt-link :to="`/${this.$store.state.locale}/products/curtain`">
                <div class="img-wrap">
                  <img
                    :src="`${this.$store.state.cdn}/2018/10/eba1ec6bd9e7ab3ceca229a4084896eb.png`"
                    alt
                  >
                </div>
                <div class="content-wrap">
            ...
            <div class="column is-6">
              <nuxt-link :to="`/${this.$store.state.locale}/products/switch`">
                <div class="img-wrap">
                  <img
                    :src="`${this.$store.state.cdn}/2018/10/439124df4d5c053206878fa9ee9e721e.png`"
                    alt
                  >
                </div>
                <div class="content-wrap">
            ...
            <div class="column is-6">
              <nuxt-link :to="`/${this.$store.state.locale}/products/dimmer`">
                <div class="img-wrap">
                  <img
                    :src="`${this.$store.state.cdn}/2018/10/67ccdc28db8f9a5a37326dec3bb6f731.png`"
                    alt
                  >
                </div>
                <div class="content-wrap">
            ...
            <div class="column is-6">
              <nuxt-link :to="`/${this.$store.state.locale}/products/shutter`">
                <div class="img-wrap">
                  <img
                    :src="`${this.$store.state.cdn}/2018/10/5e9170adb6e8bdb4cb53268f1f569458.png`"
                    alt
                  >
                </div>
                <div class="content-wrap">
          ...
          <div class="columns is-multiline">
            <div class="column">
              <nuxt-link :to="`/${this.$store.state.locale}/products/bulb`">
                <div class="img-wrap">
                  <img
                    :src="`${this.$store.state.cdn}/2018/10/d91f2c8f481bc4acb44c64c341624fe7.png`"
                    alt
                  >
                </div>
                <div class="content-wrap">
            ...
            <div class="column">
              <nuxt-link :to="`/${this.$store.state.locale}/products/colorstrip`">
                <div class="img-wrap center is-multiline">
                  <img
                    :src="`${this.$store.state.cdn}/2018/10/3a31cea49aa01e84f3e92cf25abee67e.png`"
                    alt
                  >
                </div>
                <div class="content-wrap">
          ...
          <div class="columns is-multiline">
            <div class="column is-6-tablet is-6-fullhd">
              <nuxt-link :to="`/${this.$store.state.locale}/products/door&window`">
                <div class="img-wrap">
                  <img
                    :src="`${this.$store.state.cdn}/2018/10/e95ad8faff6f05c47e7a16685b1bd9b3.png`"
                    alt
                  >
                </div>
                <div class="content-wrap">
            ...
            <div class="column is-6-tablet is-6-fullhd">
              <nuxt-link :to="`/${this.$store.state.locale}/products/watersensor`">
                <div class="img-wrap">
                  <img
                    :src="`${this.$store.state.cdn}/2018/10/3f2bec3082cc8a74843e3df4bfb63588.png`"
                    alt
                  >
                </div>
                <div class="content-wrap">
            ...
            <div class="column is-6-tablet is-6-fullhd">
              <nuxt-link :to="`/${this.$store.state.locale}/products/multisensor`">
                <div class="img-wrap">
                  <img
                    :src="`${this.$store.state.cdn}/2018/10/d70a537d7672355de18b8effec9b5001.png`"
                    alt
                  >
                </div>
                <div class="content-wrap">
            ...
            <div class="column is-6-tablet is-6-fullhd">
              <nuxt-link :to="`/${this.$store.state.locale}/products/motionsensor`">
                <div class="img-wrap">
                  <img
                    :src="`${this.$store.state.cdn}/2018/10/5a9adf7ada73b4fbebcc96950264bc2a.png`"
                    alt
                  >
                </div>
                <div class="content-wrap">
          ...
          <div class="columns is-gapless">
            <div class="column is-8">
              <nuxt-link :to="`/${this.$store.state.locale}/products/infinitydock`">
                <div class="img-wrap">
                  <img
                    :src="`${this.$store.state.cdn}/2018/10/27db8c27766c4c6b4dff615ebf0e0e2c.png`"
                    alt
                  >
                </div>
              </nuxt-link>
          ...
          <div class="columns is-multiline">
            <div class="column is-6-tablet is-6-fullhd">
              <nuxt-link :to="`/${this.$store.state.locale}/products/watersensordock`">
                <div class="img-wrap">
                  <img
                    :src="`${this.$store.state.cdn}/2018/10/a3793ecf4046132d34f46b02a91e67a1.png`"
                    alt
                  >
                </div>
                <div class="content-wrap">
            ...
            <div class="column is-6-tablet is-6-fullhd">
              <nuxt-link :to="`/${this.$store.state.locale}/products/rangeextander`">
                <div class="img-wrap">
                  <img
                    :src="`${this.$store.state.cdn}/2018/10/d4ec42815ba57a023fc28d596471c36b.png`"
                    alt
                  >
                </div>
                <div class="content-wrap">
            ...
            <div class="column is-6-tablet is-6-fullhd">
              <nuxt-link :to="`/${this.$store.state.locale}/products/siren`">
                <div class="img-wrap">
                  <img
                    :src="`${this.$store.state.cdn}/2018/10/45d1cb63fdfda346832b1c1068839fec.png`"
                    alt
                  >
                </div>
                <div class="content-wrap">
            ...
            <div class="column is-6-tablet is-6-fullhd">
              <nuxt-link :to="`/${this.$store.state.locale}/products/sirenplus`">
                <div class="img-wrap">
                  <img
                    :src="`${this.$store.state.cdn}/2018/10/de5322230c57b2555ea260610b64c415.png`"
                    alt
                  >
                </div>
                <div class="content-wrap">
            ...
            <div class="column is-6-tablet is-6-fullhd">
              <nuxt-link :to="`/${this.$store.state.locale}/products/irblaster`">
                <div class="img-wrap">
                  <img
                    :src="`${this.$store.state.cdn}/2018/10/015c865b905c9538339bef5eaa3dd0e9.png`"
                    alt
                  >
                </div>
                <div class="content-wrap">
            ...
            <div class="column is-6-tablet is-6-fullhd">
              <nuxt-link :to="`/${this.$store.state.locale}/products/irblasterac`">
                <div class="img-wrap">
                  <img
                    :src="`${this.$store.state.cdn}/2018/10/bcb33af07107428248c0ee7288334c5e.png`"
                    alt
                  >
                </div>
                <div class="content-wrap">
        ...
        <div class="thirdProducts has-text-centered">
          ...
          <div class="columns is-multiline is-variable is-7">
            <div
              class="column is-4-tablet is-one-third-desktop is-one-quarter-widescreen is-2-fullhd"
              v-for="(product, index) in thirdProducts"
              :key="index"
            >
              <div class="item center">
                <img
                  :src="product._embedded['wp:featuredmedia'][0].source_url"
                  v-if="product._embedded['wp:featuredmedia']"
                >
          ...
          <div class="modal-card">
            ...
            <section class="modal-card-body">
              <img
                ...
                class="productImage"
                :src="`${$store.state.cdn}/${currentProduct.image}`"
              >
              <div class="specification" v-html="currentProduct.content.rendered"></div>
            </section>
...
export default {
  head() {
    return {
      title: '产品中心_OOMI_智能家居设备_OOMI智能家居系统',
      meta: [
        {
          name: 'keywords',
          content:
            'OOMI智能家居系统,智能家庭网关,智能传感器,智能灯泡,智能警示器,智能开关,智能插座,智能红外转换器,智能场景面板'
        },
        {
          name: 'description',
          content:
            '丰唐物联技术（深圳）有限公司的产品在设计上满足了用户舒适生活的同时突出时尚感、科技感，并且安装便捷，操作简单，轻松实现对灯光、窗帘、空调、影音等家电全方位智能控制。'
        }
      ]
    }
  },
