  ...
  <main class="main">
    ...
    <section class="application-features">
      ...
      <div class="container-fluid">
        <div class="columns">
          <div class="column">
            <img :src="`${this.$store.state.cdn}/2018/09/0a4de4e96dd47bbf2bdbb47f9ef0edce.jpg`" alt>
          </div>
        </div>
      </div>
      ...
      >{{$t('一键开启聚会模式。周末约上三五好友，来家中开启一场久违的Party！在闪烁的温暖灯光下、适宜的音乐中，让老友的情谊更加绵长。')}}</div>
      <div class="container-fluid">
        <div class="columns is-gapless">
          <div class="column">
            <img :src="`${this.$store.state.cdn}/2018/09/22445f1310f66155120c4a1fb56baf96.jpg`" alt>
          </div>
        </div>
      </div>
      <div
        class="mode"
        :style="{backgroundImage: `url(${$store.state.cdn}/2018/09/6e2488db67f477e5d315de1952b2ef0e.jpg)`}"
      >
          ...
          <div class="columns">
            <div class="column">
              <div class="item">
                ...
                <div
                  class="subtitle center is-size-6"
                >{{$t('饭后，坐在客厅一键开启影院模式，影院布帘缓缓降下，窗帘会悄然关闭，灯光自动调节到合适的亮度，投影机开启，美好的影院时光就此开启！')}}</div>
                <img
                  :src="`${this.$store.state.cdn}/2018/09/74dd4a6bfb02757c8e65cc904aebee4c.jpg`"
                  alt
                >
              </div>
            </div>
            <div class="column">
              <div class="item">
                ...
                <div
                  class="subtitle center is-size-6"
                >{{$t('当您悠闲地坐在露台凝望夕阳西下时，当您在与爱人共进烛光晚餐时，当您在午后的起居室里读着自己心爱的诗集时，当您兴致勃勃的与挚友品鉴美酒时，当您慵懒的地家中泡SPA时…美妙动听的音乐将使您更加陶醉其中。')}}</div>
                <img
                  :src="`${this.$store.state.cdn}/2018/09/27a369bcd3c83c44a71424fa6fda7ddf.jpg`"
                  alt
                >
              </div>
            </div>
...
export default {
  ...
  head() {
    return { title: this.$t('应用场景') + '-' + this.$t('娱乐模式') }
  },
  data() {
    return {
      hero: {
        ...
        }/2018/09/5d00b77bdb215e4a2bc2979c1efd050f.jpg`,
        isnum: 'is-12',
        isalgin: '',
      ...
      suit: {
        title: this.$t('娱乐模式 套装选择'),
        subtitle: this.$t('娱乐模式套装选择（适用于有网络的小户型家庭）'),
        character: [
          this.$t('多元交互体验'),
          this.$t('联动其他智能设备'),
          this.$t('随心拓展配件')
        ...
        img: `${
          this.$store.state.cdn
        }/2018/09/0124b52a5e2795a23032715df84c8608.png`,
