<template>
  <section class="solution-header">
    <div class="container">
      <div class="columns">
        <div class="column is-offset-4 is-2 has-text-centered">
          <nuxt-link :to="`/${this.$store.state.locale}/solution/villa`" :class="{'is-active': mode=='villa'}">
        ...
        <div class="column is-2 has-text-centered">
          <nuxt-link :to="`/${this.$store.state.locale}/solution/hotel` " :class="{'is-active': mode=='hotel'}">
        ...
        <div class="column is-2 has-text-centered">
          <nuxt-link :to="`/${this.$store.state.locale}/solution/community`" :class="{'is-active': mode=='community'}">
        ...
        <div class="column is-2 has-text-centered">
          <nuxt-link :to="`/${this.$store.state.locale}/solution/education`" :class="{'is-active': mode=='education'}">
