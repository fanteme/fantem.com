...
export default {
  ...
  data() {
    return {
      slides: [
        {
          img: `${this.$store.state.cdn}/fantem/banner4.jpg`,
        ...
        {
          img: `${this.$store.state.cdn}/fantem/banner2.png`,
        ...
        {
          img: `${this.$store.state.cdn}/fantem/banner3.png`,
        ...
        {
          img: `${this.$store.state.cdn}/fantem/banner1.png`,
