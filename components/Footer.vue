      ...
      <div class="columns">
        ...
        <div class="column has-text-right">
          <ul class="is-inline-flex link">
            <li>
              <a @click.prevent="switchLang('zh')">中文</a>
            </li>
            <li>
              <span>|</span>
            </li>
            <li>
              <a @click.prevent="switchLang('en')">ENG</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="go2top center" v-show="isDisplay2Top" :title="$t('返回顶部')">
      ...
      >
        <g fill-rule="nonzero" fill="none">
          <path
            d="M21 12.5c-.3 0-.5-.1-.7-.3l-9-9.2-9 9.2c-.4.4-1 .4-1.4 0-.4-.4-.4-1 0-1.4l9.7-9.9c.4-.4 1.1-.4 1.4 0l9.7 9.9c.4.4.4 1 0 1.4-.2.2-.5.3-.7.3z"
            id="Shape"
            fill="#3E3A39"
          ></path>
          <path
            d="M17.4 22.5h-12.4c-.6 0-1-.4-1-1s.4-1 1-1h12.4c.6 0 1 .4 1 1s-.5 1-1 1z"
            fill="#EE7623"
          ></path>
        </g>
      </svg>
